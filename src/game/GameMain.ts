...
import InitCommand from "./core/commands/inits/InitCommand";
...
import { EpisodeManager } from './episode/managers/EpisodeManager.ts';
import { ProgressionProxy } from './episode/proxies/ProgressionProxy.ts';
...
export default class GameMain {
    ...
    public static Start(): void {
        ...
        if (EpisodeManager.CurrentEpisode) {
            // TODO: Resume game progress
            console.log(ProgressionProxy.Progressions);
        }
