...
const TheaterPreloadReactView = memo(
  ({ className = '', ...props }: TransitionProps) => {
    ...
    return (
      <OpacityAnimatedReactView
        {...props}
        className={`theaterPreloadReactView ${className}`}
      >
        <div className="theaterPreloadReactView__progress">
          <div
